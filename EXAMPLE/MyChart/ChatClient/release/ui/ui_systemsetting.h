...
public:
    ...
    void setupUi(QWidget *SystemSetting)
    {
        ...
        checkBoxLocalHost->setObjectName(QString::fromUtf8("checkBoxLocalHost"));

        verticalLayout_3->addWidget(checkBoxLocalHost);

        btnSaveSetting = new QPushButton(groupBox);
        btnSaveSetting->setObjectName(QString::fromUtf8("btnSaveSetting"));
        ...
        toolBtnLeftClr->setObjectName(QString::fromUtf8("toolBtnLeftClr"));

        gridLayout->addWidget(toolBtnLeftClr, 1, 3, 1, 1);

        toolBtnClr = new QToolButton(groupBox_2);
        toolBtnClr->setObjectName(QString::fromUtf8("toolBtnClr"));
        ...
        lineEditRightBubble->setObjectName(QString::fromUtf8("lineEditRightBubble"));
        ...
        lineEditLeftBubble->setObjectName(QString::fromUtf8("lineEditLeftBubble"));
        ...
        lineEditClrBackground->setObjectName(QString::fromUtf8("lineEditClrBackground"));
        ...
        labelLeftBubbleClr->setObjectName(QString::fromUtf8("labelLeftBubbleClr"));
        ...
        labelRightBubbleClr->setObjectName(QString::fromUtf8("labelRightBubbleClr"));
